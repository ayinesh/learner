...
This module configures Alembic for async SQLAlchemy with our application's
...
from src.modules.auth.models import UserModel, RefreshTokenModel
from src.modules.user.models import UserProfileModel, UserSourceConfigModel
